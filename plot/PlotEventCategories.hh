#ifndef PLOT_EVENT_CATEGORIES_HH
#define PLOT_EVENT_CATEGORIES_HH
...
namespace plot_utils
{
    ...
    public:
        ...
        {
            static const std::vector<int> keys = {15};
            return keys;
        }

        static const std::vector<int> &mc_keys()
        {
            static const std::vector<int> keys = {1, 2, 10, 11, 12, 13, 14, 15, 16, 17, 19, 20, 99};
            return keys;
        }
    ...
    private:
        ...
        static const std::map<int, Properties> &mapping()
        {
            static const std::map<int, Properties> m = {
                {0, {0, "unknown", "Unknown", kBlack, 1001}},
                ...
                {99, {99, "data_inclusive", "Inclusive Data", colour_from_hex("#c32910"), 1001}}};
            return m;
        }
    };
}

#endif // PLOT_EVENT_CATEGORIES_HH
